...
D = 38.05; % diffusion coefficient for GFP in 7% PA (Stokes-Einstein), in µm^2 s^-1, see Damkohler_calcs_fixedD_ingel
...
for k=[0.000380523,0.003805233,0.007610467,0.0114157,0.019026167,0.026636634,0.038052335,0.076104669,0.190261673];
%for k=[0.02692813,0.44880216],

%print k value to track progress
k
...
exportgraphics(fig, 'test1_ingel.png', 'ContentType', 'image', 'BackgroundColor', 'k'); % black background
exportgraphics(fig, 'test2_ingel.png', 'ContentType', 'image', 'BackgroundColor', 'w'); % white background

% load exported images back in and scale to [0,1]
u = imread('test1_ingel.png');
u = double(u) / 255;
v = imread('test2_ingel.png');
...
% store again
imwrite(uint8(c*255), 'Damkohler_calcs_overlayplot_matlab_ingel.png', 'Alpha', a);
...
csvwrite('spread_dist_ingel.csv',FWHM_holder_holder_diff_sub);
